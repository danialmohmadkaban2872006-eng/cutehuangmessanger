...
<<<<<<< HEAD
// Inline SVG icon system — no external icon library needed
import React from "react";
=======
// Inline SVG icon system — reused from original design
...
>>>>>>> d2bbc2438c1412cd08031520573891ee09832ada
  phone: <><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.34 9.35 19.79 19.79 0 01.25 4.55 2 2 0 012.22 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></>,
...
>>>>>>> d2bbc2438c1412cd08031520573891ee09832ada
  ...
  checkDouble: <><polyline points="17 1 11 7 5 1"/><polyline points="21 5 11 15 1 10"/></>,
  ...
  pin: <><line x1="12" y1="17" x2="12" y2="22"/><path d="M5 17H19V12C19 8.67 16.33 6 13 6H11C7.67 6 5 8.67 5 12V17Z"/><path d="M9 6V4C9 2.9 9.9 2 11 2H13C14.1 2 15 2.9 15 4V6"/></>,
